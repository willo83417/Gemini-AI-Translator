  ...
  en: {
    translation: {
      ...
      settings: {
        ...
        enableGemmaAudioRealtimeLabel: 'Gemma 3N Audio Realtime',
        enableGemmaAudioRealtimeDescription: 'Realtime speech recognition for Gemma 3N audio.',
  ...
  ja: {
    translation: {
      ...
      settings: {
        ...
        enableGemmaAudioLabel: 'Gemma 3N ネイティブオーディオ',
        enableGemmaAudioDescription: 'LLMのネイティブオーディオ機能を使用します。オフライン翻訳モードが必要です。',
        enableGemmaAudioRealtimeLabel: 'Gemma 3N オーディオリアルタイム',
        enableGemmaAudioRealtimeDescription: 'Gemma 3Nオーディオのリアルタイム音声認識。',
  ...
  'zh-TW': {
    translation: {
      ...
      settings: {
        ...
        enableGemmaAudioRealtimeLabel: 'Gemma 3N 音訊即時處理',
        enableGemmaAudioRealtimeDescription: '即時辨識並轉換成文字 (Gemma 3N)',
